      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            >
              {aboutSectionData.highlights.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between p-4 rounded-xl bg-surface border border-white/15 transition-all duration-300 hover:-translate-y-1.5 hover:border-primary hover:bg-[#222222] hover:shadow-xl hover:shadow-primary/15 group cursor-pointer"
                >
          ...
          >
            ...
            <div className="relative w-full h-70 lg:h-120 rounded-2xl overflow-hidden bg-surface border border-white/15 shadow-2xl transition-all duration-500 group-hover:border-primary">
              <img
